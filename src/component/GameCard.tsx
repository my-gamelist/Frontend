...
export default function GameCard(props: IGame) {
    return (
        <div className="flex relative w-full h-80 rounded-xl bg-gradient-to-r from-sky-500 to-indigo-500">
            <div className="flex flex-col relative w-full h-80 transition duration-300 hover:translate-x-3 hover:-translate-y-3">
