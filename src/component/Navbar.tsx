...
export default function Navbar() {
    return (
        <div className="flex w-screen h-24 bg-white bg-opacity-30 justify-center items-center">
            <Searchbar />
            <div className="flex absolute transition ease-in-out delay-10 right-10 w-28 h-10 bg-white bg-opacity-30 hover:bg-opacity-50 text-white justify-center items-center rounded-full">
